...
const Books = () => {
    ...
    useEffect(() => {
        const fetchCustomers = async () => {
            try {
                const response = await axios.get('http://localhost:3030/customers'); // Ensure this endpoint is correct
    ...
    const handleDelete = async (customerId) => {
        try {
            ...
            setCustomers(customers.filter((customer) => customer.customerID !== customerId)); // Use customerID
        } catch (error) {
